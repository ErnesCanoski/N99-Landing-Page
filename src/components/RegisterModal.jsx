      ...
      >
        ...
        <div className="p-8 pt-10">
          {submitted ? (
            ...
            <div className="flex flex-col items-center text-center gap-6 py-6">
              ...
              <div>
                ...
                <p className="text-ink-muted leading-relaxed">
                  Welcome, <span className="text-brand-cyan font-semibold">{form.firstName} {form.lastName}</span>!
                  <br />
                  A confirmation will be sent to{" "}
                  <span className="text-brand-cyan">{form.email}</span>.
                  <br className="mb-1" />
                  <span className="text-ink-muted text-sm">See you in Skopje on May 8th, 2026 🎉</span>
                </p>
              </div>
              <button
                onClick={onClose}
            ...
            <>
              <div className="mb-8">
                <p className="text-[0.7rem] font-bold tracking-[3px] uppercase text-brand-cyan mb-1.5 items-center text-center">
                  N99 AI Deep Tech Summit · Skopje 2026
                </p>
                <h2 className="font-exo font-black text-[2rem] text-ink leading-tight items-center text-center">
                  Register For Free 
                </h2>
                <p className="text-ink-muted text-sm mt-1.5 items-center text-center">
